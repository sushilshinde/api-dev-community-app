...
function buildResponse(p) {
    ...
    const ENV_DETAILS = {
      "build-dev":{name:"Developement","url":"https://community-app.topcoder-dev.com","api":"Development","apiUrl":"https://api.topcoder-dev.com"},
      "build-prod-beta":{name:"Beta","url":"https://beta-community-app.topcoder.com","api":"Production","apiUrl":"https://api.topcoder.com"},
      "build-prod-staging":{name:"Staging","url":"https://staging-community-app.topcoder.com","api":"Production","apiUrl":"https://api.topcoder.com"},
